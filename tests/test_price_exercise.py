...
@pytest.fixture
def deploy_price_exercise(get_job_id, chainlink_fee, get_link_token, get_eth_usd_price_feed_address):
    # Arrange
...
def test_can_get_latest_price(get_job_id, chainlink_fee, get_link_token, get_eth_usd_price_feed_address):
    # Arrange
    address = get_eth_usd_price_feed_address
    # Arrange / Act
    price_exercise = PriceExercise.deploy(
